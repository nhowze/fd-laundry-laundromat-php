 ...
 */
define("HOST", $_ENV['MYSQL_HOST']); 			// The host you want to connect to. 
define("USER", $_ENV['MYSQL_USER']); 			// The database username. 
define("PASSWORD", $_ENV['MYSQL_PASSWORD']); 	// The database password. 
define("DATABASE", "nhowze_delivrmat");             // The database name.
