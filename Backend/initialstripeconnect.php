...
if (isset($_GET['code'])) { // Redirect w/ code
	...
	$mysqli->query("UPDATE Laundromat SET StripeAccount = '".$resp['stripe_user_id']."' WHERE email = '".$_SESSION['username']."' ");
...
if($row['Type'] == "Test"){
    	...
    	$mysqli->query("UPDATE Laundromat SET StripeAccount = 'acct_1GVKOQKKF4QHEAIU' WHERE email = '".$_SESSION['username']."' ");
