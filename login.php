	...
	<body class="is-preload">
					...
					<!-- Nav -->
						<nav id="nav">
							<ul>
								...
								<li><a href="login.php" id="contact-link" style="color:white;"><span ><img src="../images/app-logo-transparent.png" style="width:10%;" alt="" />Login</span></a></li>
		...
		<!-- Main -->
			<div id="main">
				...
				<!-- Portfolio -->
					<section id="portfolio" class="two"><table style="width:100%;  top:0; position:fixed; min-height:60px; z-index: 2;"><th style="color:white; font-size:100%; background: #44525a; text-align:center;">Login</th></table>
