...
if (mysqli_num_rows($result)) {
    ...
    $query = "update " . $table_name . "	 set password='$pwd' , activ_status=1 where email='$username'";
    ...
    $sqlsu = "SELECT * FROM Laundromat WHERE email = '".$_SESSION['username']."' ";

    $confirm2= mysqli_query($mysqli, $sqlsu);

    $confirm2= mysqli_fetch_assoc($confirm2);
    ...
    $_SESSION['passwordmess'] = "Your password was updated successfully!";
